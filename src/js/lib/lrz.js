...
var Promise          = require('./lrzlib/Promise'),
    BlobFormDataShim = require('./lrzlib/Blob.FormData.shim'),
    exif             = require('./lrzlib/exif');
...
Lrz.prototype._createBase64ForOldIOS = function () {
    ...
    return new Promise(function (resolve) {
        require(['./lrzlib/megapix-image'], function (MegaPixImage) {
...
Lrz.prototype._createBase64 = function () {
    ...
    return new Promise(function (resolve) {
        if (UA.oldAndroid || UA.mQQBrowser || !navigator.userAgent) {
            require(['./lrzlib/jpeg_encoder_basic'], function (JPEGEncoder) {
